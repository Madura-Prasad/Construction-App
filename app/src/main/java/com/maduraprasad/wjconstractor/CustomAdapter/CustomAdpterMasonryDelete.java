...
public class CustomAdpterMasonryDelete extends RecyclerView.Adapter<CustomAdpterMasonryDelete.MasonryDeleteMYViewHolder> {
    ...
    public CustomAdpterMasonryDelete(Activity activity, Context context, ArrayList masonry_id, ArrayList masonry_name, ArrayList masonry_address, ArrayList masonry_nic, ArrayList masonry_age, ArrayList masonry_sname) {
    ...
    @NonNull
    @Override
    public MasonryDeleteMYViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.my_rowaddmasonry, parent, false);
        return new MasonryDeleteMYViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MasonryDeleteMYViewHolder holder, int position) {
        ...
        holder.mainLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, AdminDelete_MasonryActivity.class);
    ...
    public class MasonryDeleteMYViewHolder extends RecyclerView.ViewHolder {
        TextView masonry_id_txt, masonry_name_txt, masonry_address_txt, masonry_nic_txt, masonry_age_txt,masonry_sname_txt;
        LinearLayout mainLayout;
        public MasonryDeleteMYViewHolder(@NonNull View itemView) {
            super(itemView);
