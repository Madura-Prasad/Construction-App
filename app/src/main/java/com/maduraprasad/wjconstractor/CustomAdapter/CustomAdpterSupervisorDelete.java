...
import com.maduraprasad.wjconstractor.AdminDeleteView_SupervisorActivity;
import com.maduraprasad.wjconstractor.AdminDelete_SupervisorActivity;
...
public class CustomAdpterSupervisorDelete extends RecyclerView.Adapter<CustomAdpterSupervisorDelete.SuperviosrDeleteMYViewHolder> {
    ...
    public CustomAdpterSupervisorDelete(Activity activity, Context context, ArrayList supervisor_id, ArrayList supervisor_name, ArrayList supervisor_email, ArrayList supervisor_password, ArrayList supervisor_cpassword) {
    ...
    @NonNull
    @Override
    public SuperviosrDeleteMYViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.my_rowaddsuperviosr, parent, false);
        return new SuperviosrDeleteMYViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SuperviosrDeleteMYViewHolder holder, int position) {
        ...
        holder.mainLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, AdminDelete_SupervisorActivity.class);
    ...
    public class SuperviosrDeleteMYViewHolder extends RecyclerView.ViewHolder {
        TextView supervisor_id_txt, supervisor_name_txt, supervisor_email_txt, supervisor_password_txt, supervisor_cpassword_txt;
        LinearLayout mainLayout;
        public SuperviosrDeleteMYViewHolder(@NonNull View itemView) {
            super(itemView);
