...
public class _Supervisor_Update_DeleteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity___supervisor__update__delete);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DBConnector dbConnector = new DBConnector(_Supervisor_Update_DeleteActivity.this);
                name = supervisor_name.getEditText().getText().toString().trim();
                email = supervisor_email.getEditText().getText().toString().trim();
                password = supervisor_password.getEditText().getText().toString().trim();
                cpassword = supervisor_cpassword.getEditText().getText().toString().trim();
                dbConnector.UpdateDataSupervisor(id, name, email, password, cpassword);
            }
        });
    ...
    public void finish() {
        super.finish();
        customType(_Supervisor_Update_DeleteActivity.this, "fadein-to-fadeout");
    }
}