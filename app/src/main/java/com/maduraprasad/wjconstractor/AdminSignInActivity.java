...
public class AdminSignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (name != null) {
            Intent intent = new Intent(getApplicationContext(), AdminMainHomeActivity.class);
            startActivity(intent);
            customType(AdminSignInActivity.this, "fadein-to-fadeout");
        }
    }
    ...
    private void successDialog() {
        ...
        alertDialogBuilder
                .setMessage("Administrator Logged Successfully!")
                .setCancelable(false)
