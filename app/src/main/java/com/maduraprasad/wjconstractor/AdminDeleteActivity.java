    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        supervisor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AdminDeleteActivity.this, AdminDeleteView_SupervisorActivity.class);
                startActivity(intent);
                customType(AdminDeleteActivity.this, "fadein-to-fadeout");
            }
        });
        ...
        masonry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdminDeleteActivity.this, AdminDeleteView_MasonryActivity.class);
                startActivity(intent);
                customType(AdminDeleteActivity.this, "fadein-to-fadeout");
            }
        });
